...
export default function StorageConfigPage() {
  ...
  return (
    <div className={styles.page}>
      <Form className={styles.layout} form={form} layout="vertical" onFinish={(values) => void handleSave(values)}>
        <div className={styles.mainPanel}>
          ...
          >
            <div className={styles.fieldGrid}>
              ...
              <Form.Item className={styles.fieldSpan2} label="API Token">
        ...
        <div className={styles.sidePanel}>
          <Card title="操作" className={`${styles.formCard} ${styles.actionCard}`}>
